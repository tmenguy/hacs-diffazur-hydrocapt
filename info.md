...
1. Click install.
1. In the HA UI go to "Configuration" -> "Integrations" click "+" and search for "Diffazur Hydrocapt".
...
[license]: https://github.com/tmenguy/hacs-diffazur-hydrocapt/blob/main/LICENSE
