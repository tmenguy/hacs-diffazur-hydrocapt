"""Tests for Diffazur Hydrocapt api."""
import asyncio

import aiohttp
from homeassistant.helpers.aiohttp_client import async_get_clientsession

from custom_components.diffazur_hydrocapt.api import (
    DiffazurHydrocaptApiClient,
)
...
async def test_api(hass, aioclient_mock, caplog):
    ...
    api = DiffazurHydrocaptApiClient("test", "test", async_get_clientsession(hass))
